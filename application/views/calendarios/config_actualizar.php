<link href="<?php echo base_url()?>librerias/fullcalendar/fullcalendar.css" rel="stylesheet" type="text/css" />
<script src="<?php echo base_url()?>librerias/fullcalendar/fullcalendar.min.js" type="text/javascript"></script>
