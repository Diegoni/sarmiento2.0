			...
			<div class="panel panel-default">
				...
				<div class="col-xs-12 divider text-center">
							<div class="col-xs-12 col-sm-4 emphasis">
                                ...
                                <div class="inner">
                                    <h4>
																			<?php echo "$ ".(isset($remito_total) ? round($remito_total,2) : 0)?>
                                    </h4>
                                </div>
                                <a href="#" class="small-box-footer">
                                   REMITOS
							...
							<div class="col-xs-12 col-sm-4 emphasis">
                                ...
                                <div class="inner">
                                    <h4>
                                       <?php echo "$ ".(isset($devolucion_total) ? round($devolucion_total,2) : 0)?>
                                    </h4>
                                </div>
                                <a href="#" class="small-box-footer">
                                   DEVOLUCIONES
							...
							<div class="col-xs-12 col-sm-4 emphasis">
                                ...
                                <div class="inner">
                                    <h4>
																			<?php echo "$ ".(isset($remito_total) && isset($devolucion_total)  ? round($remito_total-$devolucion_total,2) : 0)?>
                                    	</h4>
                                </div>
                                <a href="#" class="small-box-footer">
