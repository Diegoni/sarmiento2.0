    ...
    <div class="collapse navbar-collapse" id="bs-example-navbar-collapse-1">
        ...
        <li class="dropdown">
          	...
          	<li><a  href='<?php echo site_url('articulos/actualizar_precios_lote')?>'>Actualizar precios</a></li>
						<li class="divider"></li>
						<li><a  href='<?php echo site_url('stock/insert')?>'>Stock generar movimientos</a></li>
						<li><a  href='<?php echo site_url('stock/stockArticulo')?>'>Stock por articulo</a></li>
						<li><a  href='<?php echo site_url('stock/stockProveedor')?>'>Stock por proveedor</a></li>
        	</ul>
        </li>
        ...
        <li class="dropdown">
					...
					<ul class="dropdown-menu">
          	<li><a  href='<?php echo site_url('presupuestos/insert')?>'>Presupuesto</a></li>
          	<li><a  href='<?php echo site_url('remitos/insert')?>'>Remito</a></li>
          	<li class="divider"></li>
          	<li><a  href='<?php echo site_url('presupuestos/crud')?>'>Ver presupuestos</a></li>
          	<li><a  href='<?php echo site_url('remitos/crud')?>'>Ver remitos</a></li>
          	<li><a  href='<?php echo site_url('devoluciones/crud')?>'>Ver devoluciones</a></li>
          	<li><a  href='<?php echo site_url('vendedores/crud')?>'>Vendedores</a></li>
						<li class="divider"></li>
          	<li><a  href='<?php echo site_url('facturas/crud')?>'>Ver facturas</a></li>
        	</ul>
        </li>
